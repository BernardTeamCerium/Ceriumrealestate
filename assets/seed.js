...
const SEED_DATA = {
  ...
  // `type`: equity | loan | reserve. Each contribution increases what the
  // business owes back to that owner; `repaid` is how much has been paid back
  // so far (distributions / loan repayments). Outstanding = amount - repaid.
  investments: [
    { id: 'i1', date: '2026-01-15', owner: 'B. Cerium', property: 'p1', type: 'equity', amount: 120000, repaid: 0, notes: 'Initial acquisition equity' },
    { id: 'i2', date: '2026-02-03', owner: 'R. Frazier', property: 'p3', type: 'equity', amount: 200000, repaid: 25000, notes: 'Commercial tower stake' },
    { id: 'i3', date: '2026-03-12', owner: 'B. Cerium', property: 'p4', type: 'loan', amount: 45000, repaid: 15000, notes: 'Bridge loan for renovations' },
    { id: 'i4', date: '2026-04-01', owner: 'Cerium Holdings', property: '', type: 'reserve', amount: 30000, repaid: 0, notes: 'Operating reserve top-up' },
